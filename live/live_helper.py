...
def create(name,id):
    ...
    name=name.replace(" ","_")
    voice_bridge=str(id)
    create_query='allowStartStopRecording=true&attendeePW=hadafuser&autoStartRecording=false&meetingID='+id+'&moderatorPW=hadafadmin&name='+name+'&record=true&voiceBridge='+id+'&welcome=welcome'
